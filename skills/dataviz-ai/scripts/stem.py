...
def stem(text_in, client, llmmodel, prompt2, prompt3, prompt4, prompt5):
    ...
    fig = MatplotlibInterface.StemInterface(data["x"], data["y"], data["ylabel"],
                                            style_config["marker"], style_config["linelinestyle"], style_config["baselinestyle"], style_config["mcolor"], style_config["lcolor"], style_config["bcolor"],
